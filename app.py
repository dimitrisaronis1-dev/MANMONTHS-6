...
LOGO_URL = "https://raw.githubusercontent.com/Christos-Papanikolaou/Streamlit_PM_Allocation/main/SPACE%20LOGO_colored%20horizontal.png"
...
try:
    ...
    st.error(f"Error downloading template file from GitHub: {e}. Please check the URL or your internet connection.")
...
def process_allocation(uploaded_input_file, template_workbook):
    ...
    if not data:
        st.error("No valid project data found in the input file. Please check the 'ΧΡΟΝΙΚΟ ΔΙΑΣΤΗΜΑ' and 'ΑΝΘΡΩΠΟΜΗΝΕΣ' columns.")
        return None, None, None
